...
/*        float finalWorkspaceTranslationY = states.stateIsOverview || states.stateIsOverviewHidden ?
        ...
        float finalWorkspaceTranslationX = states.stateIsOverview || states.stateIsOverviewHidden ?
                mWorkspace.getOverviewModeTranslationX() : 0;
...
/*            scale.scaleX(mNewScale)
            ...
            scale.scaleY(mNewScale)
                    .scaleX(mNewScale)
                    .translationX(finalWorkspaceTranslationX)
                    .setDuration(duration)
                    .setInterpolator(mZoomInInterpolator);
...
/*            mWorkspace.setTranslationY(finalWorkspaceTranslationY);*/
            mWorkspace.setTranslationX(finalWorkspaceTranslationX);
