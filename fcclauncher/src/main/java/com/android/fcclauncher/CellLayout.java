...
import com.android.fcclauncher.BubbleTextView.BubbleTextShadowHandler;
import com.android.fcclauncher.FolderIcon.FolderRingAnimator;
import com.android.fcclauncher.accessibility.DragAndDropAccessibilityDelegate;
import com.android.fcclauncher.accessibility.FolderAccessibilityHelper;
import com.android.fcclauncher.accessibility.WorkspaceAccessibilityHelper;
...
/*            finalScale = getChildrenScale() - 4.0f / child.getWidth();*/
            finalScale = getChildrenScale() - 4.0f / child.getHeight();
/*            initScale = child.getScaleX();*/
            initScale = child.getScaleY();
            this.child = child;
        }
...
/*        return getPaddingLeft() + getPaddingRight() + (mCountX * mCellWidth) +
                (Math.max((mCountX - 1), 0) * mWidthGap);*/ /*sfcheck*/
        return getPaddingLeft() + getPaddingRight() + (mCountX * mCellWidth) +
