...
import com.android.fcclauncher.CellLayout.CellInfo;
...
/*            showScrollHint(DragController.SCROLL_LEFT, d);*/
            showScrollHint(DragController.SCROLL_TOP, d);
...
/*            showScrollHint(DragController.SCROLL_RIGHT, d);*/
            showScrollHint(DragController.SCROLL_BOTTOM, d);
        } else {
...
/*            if (mCurrentScrollDir == DragController.SCROLL_LEFT) {
                ...
                mScrollHintDir = DragController.SCROLL_NONE;*/
            if (mCurrentScrollDir == DragController.SCROLL_TOP) {
                mContent.scrollTop();
                mScrollHintDir = DragController.SCROLL_NONE;
            } else if (mCurrentScrollDir == DragController.SCROLL_BOTTOM) {
                mContent.scrollBottom();
                mScrollHintDir = DragController.SCROLL_NONE;
            } else {
