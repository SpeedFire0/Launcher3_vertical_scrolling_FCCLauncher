...
import com.android.fcclauncher.DragView;
...
/*        float scale = d.dragView.getScaleX();*/
        float scale = d.dragView.getScaleY();
...
/*        float sY = -mFrom.bottom;
        ...
        float sX = -mFrom.exactCenterX() + mIconRect.exactCenterX();*//*sfcheck*//*
        ...
        if (d >= 0) {
            // sX can be reached under the MAX_ACCELERATION. Use MAX_ACCELERATION for y direction.
        ...
        float sY = -mFrom.exactCenterY() + mIconRect.exactCenterY();/*sfcheck*/
