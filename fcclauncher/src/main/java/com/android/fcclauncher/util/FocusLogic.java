...
import com.android.fcclauncher.ShortcutAndWidgetContainer;
...
/*        int[][] matrix = createFullMatrix(iconLayout.getCountX() + 1, iconLayout.getCountY());*//*sfcheck*/
        int[][] matrix = createFullMatrix(iconLayout.getCountX(), iconLayout.getCountY() + 1);/*sfcheck*/
